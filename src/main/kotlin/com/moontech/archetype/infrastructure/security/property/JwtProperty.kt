...
class JwtProperty(
    /** Llave del JWT. */
    @param:Value("\${security.jwt.key}")
    private val secretKey: String,
    @param:Value("\${security.jwt.lifeTime}")
    private val expiration: Long,
    /** Ruta para la autenticación de usuarios. */
    @param:Value("\${api.uri.data.authentication}")
    private val userAuthenticationPath: String,
    /** Lista de dominios permitidos.  */
    @param:Value("\${security.cors.origins}")
    private val cors: MutableList<String>
) {
    @Bean
