 ...
 */
@Service
class AuthenticationDetailsService(private val userRepository: UserSpringDataRepository) :
  UserDetailsService {
  override fun loadUserByUsername(username: String?): UserDetails? {
    ...
    val authorities =
      userEntity.roles.map { role -> SimpleGrantedAuthority("ROLE_${role.name}") }.toSet()

    return SpringUser(userEntity.username, userEntity.password, authorities)
  }
}
